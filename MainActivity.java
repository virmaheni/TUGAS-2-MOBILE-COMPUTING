package com.virmahr.crudandroid;
            ...
            public void onClick(View v) {
                if (text.getText().toString().trim().equals("")){
                    if (!input.getText().toString().trim().equals("")){
                        ...
                        input.setError("Inputan Masih Kosong tuh");
                    }
                } else {
                    Toast.makeText(MainActivity.this, " Text sudah diisi ya cuy, berhasil disimpan",
            ...
            public void onClick(View v) {
                if (text.getText().toString().trim().equals("")){
                    if (!input.getText().toString().trim().equals("")){
                        ...
                        input.setError("masukkan input yang akan diubah");
                    }
                } else {
                    Toast.makeText(MainActivity.this, " Text Berhasil di Update cuyyy",
                            Toast.LENGTH_LONG).show();
                }
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!text.getText().toString().trim().equals("")) {
                    ...
                    Toast.makeText(MainActivity.this, " Data Berhasil Dihapus bos quuu",
                            Toast.LENGTH_LONG).show();
                }
            }
        });
